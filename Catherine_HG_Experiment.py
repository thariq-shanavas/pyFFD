...
wavelength = 592e-9     
ls = 96e-6  # Mean free path in tissue
...
num_processes = 5       # Number of threads. Make sure there is sufficient RAM
# TODO: Add check to make sure there is sufficient RAM

num_runs = 1           # Simulate each depth this many times
depths = np.array([0e-6,5e-6,10e-6,20e-6,40e-6,60e-6,80e-6,100e-6])
#depths = np.array([100e-6])
...
def HG_donut_PSF(args):
    ...
    seed_x = HG_beam(xy_cells, seed_dx, beam_radius, u,v)   
...
if __name__ == '__main__':
    ...
    np.save('Results/Catherine_expt', HG_result)
